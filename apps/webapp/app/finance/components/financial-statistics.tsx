...
export function FinancialStatistics({ data }: FinancialStatisticsProps) {
	return (
		<SectionCard iconImage="/icons/statistics.webp" title="Moliyaviy Statistika" bare>
			<div className="flex flex-wrap gap-2">
				<div className="flex-1 min-w-[calc(50%-0.5rem)] backdrop-blur-[10px] bg-muted/50 bg-transparent rounded-4xl shadow-md border-2 px-4 py-3 flex flex-col items-center gap-1">
					<Image src="/icons/contract.webp" alt="Faol shartnomalar" width={50} height={50} sizes="50px" className="object-contain" />
				...
				<div className="flex-1 min-w-[calc(50%-0.5rem)] backdrop-blur-[10px] bg-muted/50 bg-transparent rounded-4xl shadow-md border-2 px-4 py-3 flex flex-col items-center gap-1">
					<Image src="/icons/bonus.webp" alt="Bonuslar" width={50} height={50} sizes="50px" className="object-contain" />
				...
				<div className="flex-1 min-w-[calc(50%-0.5rem)] backdrop-blur-[10px] bg-muted/50 bg-transparent rounded-4xl shadow-md border-2 px-4 py-3 flex flex-col items-center gap-1">
					<Image src="/icons/calculator.webp" alt="Qarzdorlik" width={50} height={50} sizes="50px" className="object-contain" />
				...
				<div className="flex-1 min-w-[calc(50%-0.5rem)] backdrop-blur-[10px] bg-muted/50 bg-transparent rounded-4xl shadow-md border-2 px-4 py-3 flex flex-col items-center gap-1">
					<Image src="/icons/calendar.webp" alt="Joriy oy qarzdorlik" width={50} height={50} sizes="50px" className="object-contain" />
				...
				<div className="flex-1 min-w-[calc(50%-0.5rem)] backdrop-blur-[10px] bg-muted/50 bg-transparent rounded-4xl shadow-md border-2 px-4 py-3 flex flex-col items-center gap-1">
					<Image src="/icons/money.webp" alt="Kechikkan to'lovlar" width={50} height={50} sizes="50px" className="object-contain" />
